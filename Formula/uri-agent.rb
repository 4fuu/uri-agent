class UriAgent < Formula
  ...
  on_macos do
    url "https://github.com/4fuu/uri-agent/releases/download/v2026.831.0/uri-agent-2026.831.0-aarch64-apple-darwin.tar.gz"
    sha256 "8bf709fed7e53af87535a7676ca4449c5ff63a9559f070eb27afdb84cc665118"
  end
