...
| Resume a session or understand persistence, cross-process collaboration, the model/tool loop, retries, notes, rollover, and summary checkpoints | [Sessions and context](sessions.md) |
